...
![随机矩阵理论：左侧Wigner半圆律描述特征值全局分布$\rho(x) = \frac{1}{2\pi}\sqrt{4-x^2}$，右侧特征值间距分布展示排斥效应$P(s) \sim s^2 e^{-4s^2/\pi}$，三大系综GOE/GUE/GSE分别对应实对称/Hermite/四元数自对偶矩阵](images/146_random_matrix.svg)
