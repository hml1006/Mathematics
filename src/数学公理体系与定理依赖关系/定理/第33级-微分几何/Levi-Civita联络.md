...
> **一句话大白话**：给出在弯曲面上"怎样把一个方向当作直线式平行地搬运到别处"的唯一方式——不挤不拉、只沿贴着表面的最"正直"路径滑过去，且与度量天然相容。
>
> **小例子**：在地球表面沿大圆平移一支"方向朝上的箭头"到另一侧，回来后并不严格平行（出现转角）；Levi-Civita联络就规定出这个"尽量不扭"的搬运规则，由度量唯一确定，满足无挠且保持内积。
