...
> **一句话大白话**：Weyl 群就是根系统自带的一面"镜子屋"，它把整个空间按所有根反射来洗牌；Weyl 室则是这屋子里的一块"基本拼图"，每一块都能通过 Weyl 群的翻转变到原来那块，用来数对称、分代表元。
>
> **小例子**：对 $A_2$ 根系统，Weyl 群是三角对称群 $S_3$，平面被 6 条根线切成 6 个 60° 的扇形，每个扇形就是一个 Weyl 室，且互相由反射连通。
