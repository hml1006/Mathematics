...
> **一句话大白话**：给环定义"维度"不靠标尺而靠嵌套的子结构链多能拉长；Krull 定理说，加进 $r$ 个元素生成理想能压住维度至多 $r$ 个档次——"需要的生成元数"就是维数上界。
>
> **小例子**：多项式环 $k[x_1,\dots,x_n]$ 的 Krull 维数恰为 $n$，其极值理想 $\langle x_1,\dots,x_n\rangle$ 需 $n$ 个生成元才能压住零维，亦即用理想生成元最小数决定维数。
