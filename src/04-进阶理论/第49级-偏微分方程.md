...
### 7.2 热的解析理论：Fourier 级数、Fourier 变换与热方程（1807–1822）
...
### 7.3 位势理论：Laplace 方程与 Green 函数（18–19 世纪）
...
### 7.5 波动方程的解与有限传播速度：d'Alembert 公式的现代意义
...
### 7.6 最大值原理、能量估计与存在唯一性的哲学（19–20 世纪）
...
### 7.7 泛函分析工具的渗入：Sobolev 空间、弱解与 Lax–Milgram（20 世纪中叶）
...
### 7.9 双曲方程与非线性波：守恒律、Friedrichs 与 Lax（20 世纪）
...
### 7.10 PDE 与现代物理、几何的深度交织（19–21 世纪）
