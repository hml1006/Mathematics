...
> **一句话大白话**：即便是"遍地取平均"造出来的极大算子（盯住处处取最能涨的平均），它的作用也不至于失控——超大值只可能出现在"测度可控"的小范围里，即一类"弱 $(1,1)$"的有界估值成立。
>
> **小例子**：记 $Mf(x)$ 为 $x$ 处所有球上平均的上确界，则对任意阈值 $\lambda>0$ 有 $|{x: Mf(x)>\lambda}|\le \frac{C}{\lambda}\|f\|_1$，即 $Mf$ 的"高塔"总测度受 $f$ 总质量控制。
