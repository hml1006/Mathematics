...
> **一句话大白话**：$n\ge3$ 时，没有任何正整数 $a,b,c$ 能满足 $a^n+b^n=c^n$，即"立方或更高次幂做不出直角三角形"——看着简单，却花了三百多年才被证明。
>
> **小例子**：$3^2+4^2=5^2$ 说明 $n=2$ 有解；但对 $n=3$，找不到正整数使 $a^3+b^3=c^3$，例如 $1^3+2^3=9$ 本身就不是立方。
