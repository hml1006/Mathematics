...
6. 计算 $\sin 15^\circ$（利用半角公式或差角公式）。
7. 在 $\triangle ABC$ 中，$A = 45^\circ$，$B = 60^\circ$，$a = 10$，求 $b$。
8. 在 $\triangle ABC$ 中，$a = 6$，$b = 8$，$c = 10$，求最大角的度数。
9. 已知 $\cos\theta = -\dfrac{3}{5}$，$\theta$ 在第三象限，求 $\sin 2\theta$ 和 $\cos 2\theta$。
10. （物理应用）一质点做简谐运动，其位移满足 $x(t) = 3\sin(2\pi t) + 3\sqrt{3}\cos(2\pi t)$（单位：cm）。
    - (a) 利用辅助角公式将 $x(t)$ 化为 $A\sin(2\pi t + \varphi)$ 的形式；
    - (b) 求该简谐运动的振幅、周期和初相。

### 提高题

11. 化简：$\dfrac{\sin 3x + \sin x}{\cos 3x + \cos x}$。
12. 求函数 $y = 2\sin(3x + \dfrac{\pi}{6}) - 1$ 的振幅、周期、值域，并求当 $x \in [0, \pi]$ 时函数的最大值。
13. 证明恒等式：$\dfrac{1 - \cos 2\theta}{\sin 2\theta} = \tan\theta$。
14. 在 $\triangle ABC$ 中，已知 $a = 2$，$b = \sqrt{6}$，$A = 45^\circ$，求 $\angle B$ 和 $\angle C$。
15. 利用积化和差公式，求 $\cos 20^\circ \cos 40^\circ \cos 80^\circ$ 的值。
...
6. $\sin 15^\circ = \dfrac{\sqrt{6} - \sqrt{2}}{4}$
7. $b = \dfrac{a\sin B}{\sin A} = \dfrac{10 \cdot \sin 60^\circ}{\sin 45^\circ} = \dfrac{10 \cdot \frac{\sqrt{3}}{2}}{\frac{\sqrt{2}}{2}} = 5\sqrt{6}$
8. 最大边 $c = 10$ 所对角 $C$ 最大，$\cos C = \dfrac{6^2 + 8^2 - 10^2}{2 \cdot 6 \cdot 8} = \dfrac{36 + 64 - 100}{96} = 0$，$C = 90^\circ$
9. $\sin\theta = -\dfrac{4}{5}$，$\sin 2\theta = 2 \cdot \left(-\dfrac{4}{5}\right) \cdot \left(-\dfrac{3}{5}\right) = \dfrac{24}{25}$，$\cos 2\theta = 2 \cdot \dfrac{9}{25} - 1 = -\dfrac{7}{25}$
10. (a) $x(t) = 3\sin(2\pi t) + 3\sqrt{3}\cos(2\pi t) = 6\left(\dfrac{1}{2}\sin(2\pi t) + \dfrac{\sqrt{3}}{2}\cos(2\pi t)\right) = 6\sin\left(2\pi t + \dfrac{\pi}{3}\right)$。
    (b) 振幅 $A = 6$ cm，周期 $T = \dfrac{2\pi}{2\pi} = 1$ s，初相 $\varphi = \dfrac{\pi}{3}$。
11. $\dfrac{\sin 3x + \sin x}{\cos 3x + \cos x} = \dfrac{2\sin 2x\cos x}{2\cos 2x\cos x} = \tan 2x$
12. 振幅 $A = 2$，周期 $T = \dfrac{2\pi}{3}$，值域 $[-3, 1]$。当 $x = \dfrac{\pi}{9}$ 时，$y_{\max} = 1$
13. $\dfrac{1 - \cos 2\theta}{\sin 2\theta} = \dfrac{1 - (1 - 2\sin^2\theta)}{2\sin\theta\cos\theta} = \dfrac{2\sin^2\theta}{2\sin\theta\cos\theta} = \dfrac{\sin\theta}{\cos\theta} = \tan\theta$
14. 由正弦定理 $\dfrac{a}{\sin A} = \dfrac{b}{\sin B}$，$\sin B = \dfrac{b\sin A}{a} = \dfrac{\sqrt{6} \cdot \frac{\sqrt{2}}{2}}{2} = \dfrac{\sqrt{3}}{2}$，所以 $B = 60^\circ$ 或 $120^\circ$。

    - 若 $B = 60^\circ$，则 $C = 75^\circ$
    - 若 $B = 120^\circ$，则 $C = 15^\circ$

15. 先用积化和差：$\cos 20^\circ \cos 40^\circ = \dfrac{1}{2}[\cos 60^\circ + \cos 20^\circ] = \dfrac{1}{4} + \dfrac{1}{2}\cos 20^\circ$。
