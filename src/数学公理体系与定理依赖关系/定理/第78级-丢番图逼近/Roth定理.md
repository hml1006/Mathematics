...
> **前置依赖**：Dirichlet 逼近定理、Liouville 定理、Roth 引理与 Siegel 引理（辅助多项式构造）、Taylor 展开。
...
- [Roth 定理（第81级-加性组合）](../第81级-加性组合/Roth定理.md)：同名不同理——本条目为丢番图逼近版本（代数无理数的逼近指数临界值 2）；第81级条目为加性组合版本（正密度集含三项等差级数）。
