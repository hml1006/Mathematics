...
![自由概率论：左侧经典独立性基于交换代数，混合矩可分解$E[X^nY^m]=E[X^n]E[Y^m]$，使用张量积$\otimes$；右侧自由独立性基于非交换代数，自由累积量可加$\kappa_n(a+b)=\kappa_n(a)+\kappa_n(b)$，使用自由积$\boxplus$，R-变换满足$R_{a+b}(z)=R_a(z)+R_b(z)$](images/147_free_probability.svg)
