...
范畴论的独特之处在于，它不像多数分支那样"研究某种对象"，而是追问"对象之间的关系与结构"，并把这种追问上升为数学的普遍语言。它诞生于组合拓扑对所谓"自然同构"的困惑，经由爱伦伯格与麦克莱恩之手成型，再被格罗滕迪克等推向代数几何的核心。

### 组合拓扑的追问与"自然"概念的诞生

范畴论的种子埋在组合拓扑对"自然同构"的追问里：怎样才算"两个构造天生一样"？早在 Bertrand Russell 的《数学原理》（Principia Mathematica）中就已出现用普通数学对象编码关系的萌芽，而真正有力的推动来自拓扑学——Samuel Eilenberg（萨穆埃尔·艾伦伯格）与 Saunders Mac Lane（桑德斯·麦克莱恩）在研究同调群时发现，同构记号写来容易，可"边界映射为何总与其上的自然等价相配"却难以说清。

### 1942–1945：范畴、函子与自然变换的正式定义

为解决"自然"的含糊，Eilenberg 与 Mac Lane 在 1942–1945 年间用范畴（对象＋态射＋复合＋恒等，满足结合律与单位律）、函子（保复合与恒等的结构映射）与自然变换（函子之间的协调箭头）把这套直觉精确化，并于 1945 年发表《一般自然等价理论》（General Theory of Natural Equivalences）。这篇纲领性论文奠定了范畴论的公理基础，也确立了其核心词汇——在此之后，"自然"第一次被精确界定为交换图的成立。

### 幺半范畴、普适性质与函子范式

范畴的概念随后迅速向代数深处延伸。幺半范畴（带有结合自然的张量积与单位对象，一般认为由 Mac Lane 与 Bénabou 等在其后的论著中系统发展）为张量积、monoidal 结构等提供了统一定义，成为拓扑量子场论、表示论与量子群的语言。伴随函子、极限与余极限等普适性质把积、拉回、自由对象等千差万别的构造收进同一框架：Kan 1958 年提出伴随函子，Freyd 1965 年给出伴随函子存在定理；Yoneda 引理（一般认为归功于 Nobuo Yoneda，1954 年前后）更证明"对象完全由它身上到各处的箭头簇决定"。

### 更高范畴与范畴化的代数几何

范畴论在此后走向"更高维"与"更几何"。双范畴（2-范畴）与弱 $n$-范畴把态射层级提升到对象与 2-态射乃至更高层，Bénabou、Ehresmann 等作出了早期贡献；Grothendieck（格罗滕迪克）在 1950–70 年代把范畴论抬进代数几何与同调代数的核心，用相对化、topos、谱序列统一表述庞大理论。单子（monad）与 Kleisli 范畴、Eilenberg–Moore 范畴又把逻辑、计算与代数牢牢绑在一起。范畴论由此成为"数学的数学"——不问对象何物，只问箭头为何。
