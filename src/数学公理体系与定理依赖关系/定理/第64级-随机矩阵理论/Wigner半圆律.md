...
> **前置依赖**：Hermitian 随机矩阵与经验谱分布、矩方法与 Catalan 数计数、非交叉配对组合、Stieltjes 变换与自洽方程、概率测度弱收敛。
...
- [Wigner 半圆律（第146级-随机矩阵理论）](../第146级-随机矩阵理论/Wigner半圆律.md)：与本条目为同一定理，另收录于第146级-随机矩阵理论，可交叉参考。
