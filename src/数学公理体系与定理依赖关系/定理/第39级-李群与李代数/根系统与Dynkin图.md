...
> **一句话大白话**：半单李代数就像一张"对称扑克牌"，根系统是把它的结构拆成一组带反射对称的向量，而 Dynkin 图就是给这些复杂结构画的"家族谱"，按连接规则把有限维复半单李代数彻底分完类。
>
> **小例子**：特殊线性代数 $\mathfrak{sl}_{n+1}$ 对应根系统 $A_n$，其 Dynkin 图是一条 $n$ 个点首尾相连的单链，每个点代表一个"简单根"。
