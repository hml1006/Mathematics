...
> **一句话大白话**：一个环是整个地"装进"更大环（整扩张），那么大的环里每一层"素房子"都能平稳落到小的那层里——上层无论发现什么素数，下层必有一座它的"地基"在守着，即"上楼自在、下楼有托"。
>
> **小例子**：$\mathbb{Z}\subset\mathbb{Z}[i]$ 是整扩张，高斯整数里的每个素理想如 $\langle 1+i\rangle$ 的根 $\langle 1+i\rangle\cap\mathbb{Z}=\langle 2\rangle$ 都"压住"一个有理素理想 $\langle 2\rangle$，符合 Going-up 的升降规则。
